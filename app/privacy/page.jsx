...
export default function PrivacyPage() {
  ...
  return (
    <main>
      <div className="wrap">
        <div className="site-title">Privacy Policy</div>
          ...
          <div style={{ maxWidth: '800px', margin: '0 auto', padding: '2rem' }}>
            <div className="panel-section">
              ...
              <p className="panel-text">
                This privacy policy will be updated soon. Please check back later for information about how we collect, use, and protect your personal information.
              </p>
            </div>
          </div>
        </section>
